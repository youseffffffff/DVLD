    ...
    public class clsInternationalLicense : clsApplication
    {
        ...
        private bool _AddNewInternationalLicense()
        {
            ...
            this.InternationalLicenseID =
                clsInternationalLicenses.AddNewInternationalLicense(this.AppID, this.DriverID, this.IssuedUsingLocalLicenseID,
        ...
        private bool _UpdateInternationalLicense()
        {
            ...
            return clsInternationalLicenses.UpdateInternationalLicense(
                this.InternationalLicenseID, this.AppID, this.DriverID, this.IssuedUsingLocalLicenseID,
               this.IssueDate, this.ExpirationDate,
               this.IsActive, this.CreatedByUserID);
        }
        ...
        public static clsInternationalLicense Find(int InternationalLicenseID)
        {
            ...
            if (clsInternationalLicenses.GetInternationalLicenseInfoByID(InternationalLicenseID, ref ApplicationID, ref DriverID,
            ...
            ref IssueDate, ref ExpirationDate, ref IsActive, ref CreatedByUserID))
            {
                ...
                return new clsInternationalLicense(Application.AppID,
        ...
        public static DataTable GetAllInternationalLicensesByColumn(string TaxtLike, string Column)
        {
            return clsInternationalLicenses.GetAllInternationalLicensesByColumn(TaxtLike, Column);
        }
        ...
        public static int GetActiveInternationalLicenseIDByDriverID(int DriverID)
        {
            ...
            return clsInternationalLicenses.GetActiveInternationalLicenseIDByDriverID(DriverID);
