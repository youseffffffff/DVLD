...
namespace DVLD.Licenses.Local_Licenses.Controls
{
    public partial class ctrlDriverLicenses : UserControl
    {
        ...
        private void _LoadLocalLicenseInfo()
        {
            ...
            _dtDriverLocalLicensesHistory = clsDriver.GetLocalLicenseHistory(_PersonID);
        ...
        private void _LoadInternationalLicenseInfo()
        {
            ...
            _dtDriverInternationalLicensesHistory = clsDriver.GetInternationalLicenseHistory(_PersonID);
        ...
        public void Load(int PersonID)
        {
            ...
            if (_Driver == null)
            {
                MessageBox.Show("Field To Load Data", "Errorr", MessageBoxButtons.OK, MessageBoxIcon.Error);
                return;
            }
        ...
        private void showLicenseInfoToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            ShowLicenseDetails frm = new ShowLicenseDetails(LicenseID);
            frm.ShowDialog();
        ...
        private void InternationalLicenseHistorytoolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            ShowInternationalLicenseDetails frm = new ShowInternationalLicenseDetails(InternationalLicenseID);
            frm.ShowDialog();
        }
